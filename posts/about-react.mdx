...
This is not a post that will learn you something new about React it is just a post where I want to describe in my own words how much I like and appreciate React and how to React made me a better developer. I think it is good timing now since new frameworks are coming in and they are always compared against React.
