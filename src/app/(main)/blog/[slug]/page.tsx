  ...
  return (
    ...
    <PageWrapper>
      ...
      <section className="flex justify-between border border-green-500">
        ...
        <article className="prose-sm m-auto flex max-w-none flex-col  bg-red-300 dark:prose-invert md:prose-base">
          <MDXRemote
            source={content}
            components={{
              pre: Code,
        ...
        <aside className="sticky top-0 flex max-h-[32rem]  basis-[100%] flex-col border border-red-600 xl:flex ">
